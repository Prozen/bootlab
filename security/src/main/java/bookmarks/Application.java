...
// curl -v POST  http://127.0.0.1:8080/bookmarks -d '{"uri":"http://foobar", "description":"baz"}' -H "Content-Type: application/json"  -H "Authorization: Bearer 285a2b50-e0dd-464f-98c4-b726b6f37679"
